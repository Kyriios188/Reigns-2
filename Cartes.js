...
const barbares = new carte("Barbares", "Des barbares pillent nos églises et tuent nos prêtres ! Envoyez immédiatement l'armée pour les protéger !", "Protéger les prêtres", "Ignorer leur problème", effetD_barbares, effetG_barbares, argD_barbares, argG_barbares, "./pretre2.png");

const voleur = new carte("Voleur", "Nous avons surpris un voleur qui s'était introduit dans notre cathédrale. Il tenait dans ses mains une de nos reliques, et son sac était rempli d'argenterie. Il semblerait que cet homme soit une sorte de héro du peuple qui volerait aux riches. Un certain Borin des forêts. Nous devrions l'enfermer dans nos geôles pour l'exemple...", "Emprisonner Borin des Forêts", "Relâcher Borin des Forêts", effetD_voleur, effetG_voleur, argD_voleur, argG_voleur, "./voleur.png");

const joutes = new carte("Joutes", "C'est le festival du printemps seigneur ! Bien que cela représente un coût, nous pourrions organiser des joutes pour divertir le peuple.", "Organiser les joutes", "Ne rien organiser", effetD_joutes, effetG_joutes, argD_joutes, argG_joutes, "./joute.png");

const gisement = new carte("Gisement", "Nous avons découvert un gisement de minerai. Vous pourriez utiliser le métal ainsi extrait pour équiper l'armée ou pour notre économie.", "Créer de la monnaie", "Créer des armes et de l'équipement", effetD_gisement, effetG_gisement, argD_gisement, argG_gisement, "./paysan2.png");

const academie_magie = new carte("Construction d'une académie de magie", "Nous pourrions construire une académie de magie et d'alchimie mon seigneur. Evidemment, nous ferions profiter la couronne des profits générés par l'alchimie...", "Construire l'académie", "Ne rien construire", effetD_academie_magie, effetG_academie_magie, argD_academie_magie, argG_academie_magie, "./academie_magie.png");

const banque = new carte("Construction d'une banque", "Nous pourrions construire une banque pour vous monseigneur. Elle vous permettrait de réaliser un bon profit.", "Construire la banque", "Ne rien construire", effetD_banque, effetG_banque, argD_banque, argG_banque, "./banque.png");
...
const cathedrale = new carte("Construction d'une cathédrale", "La foi du peuple est vascillante, je le sens ! Nous devrions ordonner la construction d'une grande cathédrale à la gloire des dieux.", "Construire la cathédrale", "Ne rien construire", effetD_cathedrale, effetG_cathedrale, argD_cathedrale, argG_cathedrale, "./pretre2.png");

const grenier = new carte("Construction d'une grenier", "Nos récoltes sont régulièrement à l'origine de surplus, mais sans moyen de les entreposer, ils sont perdus. Nous devrions construire un grenier pour les entreposer.", "Construire un grenier", "Ne rien construire", effetD_grenier, effetG_grenier, argD_grenier, argG_grenier, "./paysan2.png");

const taverne = new carte("Construction d'une taverne", "Le peuple s'ennuie monseigneur... Nous pourrions construire une taverne afin de leur changer les idées.", "Construire une taverne", "Ne rien construire", effetD_taverne, effetG_taverne, argD_taverne, argG_taverne, "./paysan2.png");
