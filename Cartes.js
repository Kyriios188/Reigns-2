...
const troubadour = new carte("Troubadour", "Messire ! Permettez-moi de me présenter. Je suis le grand Jean de Boër, troubadour itinérant. Je souhaitais me produire ici quelques temps. Je pourrais vous proposer une partie de mes recettes...", "Accepter sa proposition", "Lui laisser l'intégralité de ses recettes", effetD_troubadour, effetG_troubadour, argD_troubadour, argG_troubadour, "./advisor.png");

const trahison_general = new carte("Trahison du général", "Mon roi ! Votre général a comploté contre vous ! Il a rallié plusieurs officiers à sa cause et s'apprête à vous renverser. Nous devons agir !", "Exécuter les traîtres", "Envoyer le général à la guerre dans une contrée lointaine", effetD_trahison_general, effetG_trahison_general, argD_trahison_general, argG_trahison_general, "./army.png");
